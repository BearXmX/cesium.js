...
const HengduanMountains = () => {
  ...
  const showSanjiangbingliuDetails = (value: boolean) => {
    notificationApi.destroy()
  ...
  const guiControls = {
    ...
    showSanjiangbingliu: () => {
      ...
      showSanjiangbingliuDetails(true)
  ...
  const initGui = () => {
    ...
    climateControls
      ...
      .onChange((value: boolean) => {
        ...
        if (value) {
          viewerRef.current!.camera.flyTo({
            destination: Cesium.Cartesian3.fromDegrees(106.49566264, 33.8076862, 5000000.0),
            orientation: {
              heading: 6.283185307179586,
